...
const SOURCES = [
  ...
  { id: 'conference', label: 'Conference programmes', colour: '#b06fd1', verdict: 'rejected, closest miss' },
...
const W = 900, H = 520, L = 74, R = 34, T = 76, B = 118;
...
const svg = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 ${W} ${H}" role="img" aria-label="Correlation between adoption growth and hiring growth at each lag; ${head.label} peaks around ${peak.lag} months">
  ...
  <text x="${L}" y="38" font-family="Inter, Helvetica, Arial, sans-serif" font-size="19" font-weight="700" fill="#fff" letter-spacing="-0.3">Does anything lead hiring? Six tests, six failures.</text>
